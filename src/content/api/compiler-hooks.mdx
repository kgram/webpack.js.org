...
Called right after `beforeCompile`, before a new compilation is created. This hook is _not_ copied to child compilations.
...
Executed while initializing the compilation, right before emitting the `compilation` event. This hook is _not_ copied to child compilations.
...
Executed before finishing the compilation. This hook is _not_ copied to child compilations.
...
Executed right before emitting assets to output dir. This hook is _not_ copied to child compilations.
...
Called after emitting assets to output directory. This hook is _not_ copied to child compilations.
...
Executed when the compilation has completed. This hook is _not_ copied to child compilations.
...
Executed when a watching compilation has been invalidated. This hook is _not_ copied to child compilations.
